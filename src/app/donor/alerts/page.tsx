...
//       try {
//         setLoading(true);
//         // 1. Fetch donor's info to know their blood group
//         const userRes = await axios.get("/api/users/me");
//         const group = userRes.data.data.bloodGroup;
//         setDonorBloodGroup(group);

//         // 2. Fetch requests matching that blood group
//         const response = await axios.get(`/api/requests/match?bloodGroup=${group}`);
...
//           {
//             _id: "req_1",
//             patientName: "Emergency Case #402",
//             bloodGroup: "O+",
...
//           {
//             _id: "req_2",
//             patientName: "Routine Surgery",
//             bloodGroup: "O+",
//             hospitalName: "Red Crescent Clinic",
//             city: "Lahore",
//             area: "Gulberg",
//             urgency: "Normal",
//             unitsRequired: 1,
//             contactNumber: "+923219876543",
...
//               Showing emergency requests for <span className="font-bold text-red-600">{donorBloodGroup || "your blood group"}</span>
//             </p>
//           </div>
//           <div className="bg-white px-4 py-2 rounded-full border border-gray-200 text-sm font-medium text-gray-600 shadow-sm">
//             {alerts.length} Active Requests
//           </div>
//         </div>
...
//           {loading ? (
//             <div className="text-center py-20 text-gray-500">Scanning for matches...</div>
//           ) : alerts.length > 0 ? (
//             alerts.map((request) => (
//               <div 
//                 key={request._id} 
//                 className={`bg-white rounded-3xl overflow-hidden shadow-sm border-l-8 transition-all hover:shadow-md ${
//                   request.urgency === 'Critical' ? 'border-red-600' : 'border-yellow-500'
//                 }`}
//               >
//                 <div className="p-6">
//                   <div className="flex justify-between items-start mb-4">
//                     <div className="flex items-center gap-3">
//                       <div className={`p-2 rounded-lg ${request.urgency === 'Critical' ? 'bg-red-100 text-red-600' : 'bg-yellow-100 text-yellow-700'}`}>
//                         <AlertTriangle size={20} />
//                       </div>
//                       <div>
//                         <h3 className="font-bold text-gray-900 text-lg">{request.hospitalName}</h3>
//                         <p className="text-xs text-gray-500 flex items-center gap-1 uppercase tracking-wider font-bold">
//                           <Clock size={12} /> Posted {new Date(request.createdAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}
//                         </p>
//                       </div>
//                     </div>
//                     <div className="bg-red-600 text-white px-4 py-1 rounded-full font-black text-sm">
//                       {request.bloodGroup}
//                     </div>
//                   </div>
...
//                       <span className="text-sm">{request.unitsRequired} Units Required</span>
//                     </div>
//                   </div>
...
//               </div>
//               <h3 className="text-xl font-bold text-gray-800">No Urgent Requests</h3>
//               <p className="text-gray-500 max-w-xs mx-auto mt-2">
//                 Great news! There are currently no emergency requests matching your blood group in your area.
//               </p>
//             </div>
//           )}
//         </div>
...
//         {/* Information Box */}
//         <div className="mt-8 bg-white p-6 rounded-2xl border border-gray-200 flex gap-4 shadow-sm">
//           <Info className="text-blue-500 shrink-0" />
//           <p className="text-sm text-gray-600 leading-relaxed">
//             <strong>How alerts work:</strong> When a recipient or hospital creates an urgent request, our system automatically filters donors by blood group and location to send these notifications.
//           </p>
//         </div>
//       </div>
//     </div>
...
//       // 2. Fetch requests matching that blood group or universal matches
//       // Note: We use the existing requests API but filter for Pending status
//       const response = await axios.get(`/api/donor/matching-requests?bloodGroup=${group}`);
//       setAlerts(response.data.requests);
//     } catch (error) {
...
//     try {
//       await axios.post("/api/donor/respond", { requestId });
//       toast.success("Interest sent! The receiver can now see your contact.");
//       fetchAlerts(); // Refresh list to show updated state
//     } catch (error: any) {
...
//               Showing requests for <span className="text-red-600 font-bold px-2 py-0.5 bg-red-50 rounded-lg">{donorBloodGroup || "..."}</span>
//             </p>
//           </div>
//           <button 
//             onClick={fetchAlerts}
//             className="bg-white p-2 rounded-xl border border-gray-200 shadow-sm hover:bg-gray-50 transition-all"
//           >
...
//                 <div 
//                   key={request._id} 
//                   className={`bg-white rounded-[2.5rem] overflow-hidden shadow-sm border-l-[12px] transition-all hover:shadow-md ${
//                     request.urgency === 'Critical' ? 'border-red-600' : 'border-orange-500'
//                   }`}
//                 >
//                   <div className="p-8">
//                     <div className="flex justify-between items-start mb-6">
//                       <div className="flex items-center gap-4">
//                         <div className={`p-3 rounded-2xl ${request.urgency === 'Critical' ? 'bg-red-100 text-red-600' : 'bg-orange-100 text-orange-600'}`}>
...
//                         </div>
//                       </div>
//                       <div className="bg-red-600 text-white w-14 h-14 rounded-2xl flex items-center justify-center font-black text-xl shadow-lg shadow-red-200">
//                         {request.bloodGroup}
//                       </div>
//                     </div>
...
//                 There are currently no requests for {donorBloodGroup} in your city. We will alert you when someone needs your help!
//               </p>
//             </div>
//           )}
//         </div>
...
//             <strong>Privacy Note:</strong> Clicking I can Donate will share your contact number and blood group with the patient family so they can coordinate the donation with you.
//           </p>
//         </div>
//       </div>
//     </div>

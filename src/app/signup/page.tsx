...
//   // Handle role change to clear blood group if not donor
...
//           {/* Blood Group - Disabled for non-donors */}
//           <div className="space-y-1">
//             <label className={`text-sm font-medium flex items-center gap-2 ${user.role === 'receiver' ? 'text-gray-400' : 'text-gray-700'}`}>
//               <Droplets size={16} /> Blood Group
//             </label>
//             <select
...
//             </select>
//             {user.role === "receiver" && (
//               <p className="text-[10px] text-gray-400 italic">Not required for hospitals/receivers</p>
//             )}
//           </div>

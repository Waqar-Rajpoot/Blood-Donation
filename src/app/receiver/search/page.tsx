...
//   ssr: false,
//   loading: () => (
//     <div className="h-full w-full flex items-center justify-center bg-gray-50 text-gray-400 font-bold uppercase tracking-widest text-xs">
...
//   area: string;
//   phoneNumber: string;
//   // Make sure your API eventually returns these or we mock them
//   latitude?: number; 
//   longitude?: number;
// }
...
//                 className={`px-3 py-1 rounded-md text-xs font-bold transition-all ${viewMode === 'list' ? 'bg-white shadow text-red-600' : 'text-gray-600'}`}>List</button>
//                <button 
//                 onClick={() => setViewMode("map")}
//                 className={`px-3 py-1 rounded-md text-xs font-bold transition-all ${viewMode === 'map' ? 'bg-white shadow text-red-600' : 'text-gray-600'}`}>Map</button>
//             </div>
//           </div>
...
//                     className="flex-1 bg-gray-900 text-white text-xs py-3 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-black transition-all"
//                   >
//                     <Phone size={14} /> Call Now
//                   </a>
//                   <button className="flex-1 bg-gray-100 text-gray-700 text-xs py-3 rounded-xl font-bold hover:bg-gray-200 transition-all">
//                     Profile
//                   </button>
//                 </div>
//               </div>
...
//                 <p className="text-gray-500 font-bold">No donors found</p>
//                 <p className="text-xs text-gray-400 mt-1">Try changing filters</p>
//             </div>
//           )}
//         </div>
...
//             {/* View Mode Toggle for Mobile Map */}
//             <button 
//               onClick={() => setViewMode("list")}
//               className="md:hidden absolute top-4 left-4 z-[1000] bg-white px-4 py-2 rounded-full shadow-xl font-bold text-xs text-red-600 border border-red-100"
//             >
//               ← Back to List
//             </button>
